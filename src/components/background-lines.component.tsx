  ...
  return (
    <>
      <div
        ...
        style={{
          background: `
            radial-gradient(120% 100% at 50% 0%, #f6e6cf 0%, #f0d9be 60%, #e9cda9 100%),
      ...
      >
        <defs>
          <linearGradient id="stroke" x1="0" x2="1">
            <stop offset="0" stopColor="#ffe9ce" stopOpacity=".08" />
            <stop offset="1" stopColor="#ffe9ce" stopOpacity=".02" />
          </linearGradient>
          <path
            id="wave"
        ...
        <g fill="none" stroke="#3b2f28" strokeOpacity=".05" strokeWidth=".8">
